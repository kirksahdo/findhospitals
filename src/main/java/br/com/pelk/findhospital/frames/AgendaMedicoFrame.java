...
public class AgendaMedicoFrame extends javax.swing.JFrame{
    ...
    private void setDate(){
        Date date = new Date();
        dtDate.setDate(date);
        dtDate.setMinSelectableDate(date);
    }
    /**
    ...
    private void initComponents() {
        ...
        btnSaveSchedule.setText("Marcar Consulta");
        ...
        cbHour.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "06:00", "06:30", "07:00", "07:30", "08:00", "08:30", "09:00", "09:30", "10:00", "10:30", "11:00" }));
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addComponent(lblDoctorName, javax.swing.GroupLayout.DEFAULT_SIZE, 66, Short.MAX_VALUE)
                .addGap(30, 30, 30)
    ...
    private void btnSaveScheduleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveScheduleActionPerformed
        Date date = dtDate.getDate();
        Calendar calendar = new GregorianCalendar();
        calendar.setTime(date);
        int year = calendar.get(Calendar.YEAR);
        int month = calendar.get(Calendar.MONTH) + 1;
        int day = calendar.get(Calendar.DAY_OF_MONTH);
        String fullHour = cbHour.getSelectedItem().toString();
        String hourString = "", minuteString = "";
        
        boolean swap = false;
        for(int i = 0 ; i < fullHour.length() ; i++) {
            if (fullHour.charAt(i) == ':') {
                swap = true;
                continue;
            }
            if (swap) {
                minuteString += fullHour.charAt(i);
            } else {
                hourString += fullHour.charAt(i);
            }
        }
        int hour = Integer.parseInt(hourString);
        int minute = Integer.parseInt(minuteString);
        Appointment appointment = new Appointment(UserService.getUser(), year, month, day, hour, minute, this.doctor.getId(), this.clinic.getId());
        ConfirmarConsultaFrame cf = new ConfirmarConsultaFrame(this, this.hospital, this.clinic, this.doctor, appointment);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        TelaHospitaisFrame th = new TelaHospitaisFrame(this.hospital);
        th.setVisible(true);
        this.dispose();
