...
public class AppointmentTableModel extends AbstractTableModel {
    ...
    private String[] colunas = {"Hospital", "Médico", "Data", "Hora"};
    ...
    public Object getValueAt(int linha, int coluna) {
         switch(coluna){
             case 0:
                 Clinic clinic;
             try {
                 clinic = ClinicService.getClinic(dados.get(linha).getClinic());
             } catch (ClinicNotFoundException ex) {
                 return "NaN";
             }
             Hospital hospital;
             try {
                 hospital = HospitalService.getHospitalByClinicId(clinic.getId());
             ...
             case 1:
                 Doctor doctor;
             try {
                 doctor = (Doctor) UserService.getUser(dados.get(linha).getDoctor());
             ...
             case 2:
                 LocalDateTime ldt = dados.get(linha).getAppointmentDate();
